    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "size-8 bg-transparent p-0 opacity-50 hover:opacity-100 touch-manipulation active:scale-95 transition-transform"
        ),
        ...
        head_cell:
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.7rem] sm:text-xs h-8 flex items-center justify-center",
        ...
        day: cn(
          ...
          "h-8 w-full p-0 font-normal aria-selected:opacity-100 touch-manipulation active:scale-95 transition-transform text-xs sm:text-sm"
        ),
        day_range_start:
